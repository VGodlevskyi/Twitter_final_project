...
public class ConfirmationEmail {
  ...
  private final String CONFIRMATION_SUBJECT = "TwitterApp. Please confirm your registration";
  ...
  private String msgBody() {
    return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n"
            ...
            + "<tbody><tr>\n"
            + "<td width=\"70%\" height=\"53\" bgcolor=\"blue\">\n"
            + "\n"
            + "        <table role=\"presentation\" width=\"100%\" "
            ...
            +
            "font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;"
            +
